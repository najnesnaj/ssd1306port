PROJECT_NAME := ssd1306_id107 

export OUTPUT_FILENAME
#MAKEFILE_NAME := $(CURDIR)/$(word $(words $(MAKEFILE_LIST)),$(MAKEFILE_LIST))
MAKEFILE_NAME := $(MAKEFILE_LIST)
MAKEFILE_DIR := $(dir $(MAKEFILE_NAME) ) 
NRF51_SDK_DIR = /usr/src/sdk11
TEMPLATE_PATH = /usr/src/sdk11/components/toolchain/gcc
ifeq ($(OS),Windows_NT)
...
nrf51422_xxac: LINKER_SCRIPT=ssd1306_gcc_nrf51.ld
