...
static int16_t _width=64, _height=32, WIDTH=64, HEIGHT=32, cursor_x, cursor_y;
...
void ssd1306_begin(uint8_t vccstate, uint8_t i2caddr, bool reset)
{
	...
	// Init sequence for 64x32 OLED module ID107 smartwatch
	...
	ssd1306_command(SSD1306_DEACTIVATE_SCROLL);                 // 0xA6
	//	ssd1306_command(SSD1306_DISPLAYON);                 // 0xA6
